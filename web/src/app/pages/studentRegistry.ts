...
@Component({
  ...
  <div class="inputNome">
  <input type="text" nbInput  status="info" placeholder="Primeiro Nome" fullWidth>
  </div>
  <div class="inputEmail">
  <input type="text" nbInput  status="info" placeholder="Email" fullWidth>
  </div>
  <div class="inputSenha">
  <input type="text" nbInput  status="info" placeholder="Senha" fullWidth>
  </div>
  <div class="inputConfirmeSenha">
  <input type="text" nbInput  status="info" placeholder="Confirme sua senha" fullWidth>
  </div>
  <nb-select placeholder="Cursando ..." [(ngModel)]="selectedOption" status="info" style="margin-bottom: 10px">
  <nb-option value="1">Ensino Fundamental anos iniciais</nb-option>
  <nb-option value="2">Ensino Fundamental anos finais</nb-option>
</nb-select>

<nb-select *ngIf="selectedOption === '1'" id="EF1" placeholder="Ano..." status="info" style="margin-bottom: 10px">
...
<nb-select *ngIf="selectedOption === '2'" id="EF2" placeholder="Ano..." status="info" style="margin-bottom: 10px">
