...
@Component({
  ...
  <div class="inputNome">
  <input type="text" nbInput  status="info" placeholder="Nome" fullWidth>
  </div>
  ...
  <nb-select placeholder="Áreas de atuação" status="info" style="margin-bottom:10px">
    ...
    <input type="file" id="fileInput"  (change)="onFileSelected($event)" accept=".pdf, .doc, .docx">
